...
pub type TAILGATE_W<'a> = crate::BitWriter<'a, u32, CTRL_SPEC, bool, 3>;
...
pub type LPFMODE_W<'a> = crate::FieldWriter<'a, u32, CTRL_SPEC, u8, LPFMODE_A, 2, 4>;
impl<'a> LPFMODE_W<'a> {
...
pub type TIMEBASE_W<'a> = crate::FieldWriter<'a, u32, CTRL_SPEC, u8, u8, 5, 16>;
...
impl R {
    ...
    pub fn timebase(&self) -> TIMEBASE_R {
        TIMEBASE_R::new(((self.bits >> 16) & 0x1f) as u8)
    }
