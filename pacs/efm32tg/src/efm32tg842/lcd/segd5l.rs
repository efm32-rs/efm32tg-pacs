...
pub type SEGD5L_W<'a, const O: u8> = crate::FieldWriter<'a, u32, SEGD5L_SPEC, u32, u32, 24, O>;
impl R {
    #[doc = "Bits 0:23 - COM5 Segment Data"]
    #[inline(always)]
    pub fn segd5l(&self) -> SEGD5L_R {
        SEGD5L_R::new(self.bits & 0x00ff_ffff)
    }
}
impl W {
    #[doc = "Bits 0:23 - COM5 Segment Data"]
    #[inline(always)]
    #[must_use]
    pub fn segd5l(&mut self) -> SEGD5L_W<0> {
        SEGD5L_W::new(self)
    }
