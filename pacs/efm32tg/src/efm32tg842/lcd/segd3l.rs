...
pub type SEGD3L_W<'a, const O: u8> = crate::FieldWriter<'a, u32, SEGD3L_SPEC, u32, u32, 24, O>;
impl R {
    #[doc = "Bits 0:23 - COM3 Segment Data Low"]
    #[inline(always)]
    pub fn segd3l(&self) -> SEGD3L_R {
        SEGD3L_R::new(self.bits & 0x00ff_ffff)
    }
}
impl W {
    #[doc = "Bits 0:23 - COM3 Segment Data Low"]
    #[inline(always)]
    #[must_use]
    pub fn segd3l(&mut self) -> SEGD3L_W<0> {
        SEGD3L_W::new(self)
    }
