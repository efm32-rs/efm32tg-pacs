...
pub type SEGD2L_W<'a, const O: u8> = crate::FieldWriter<'a, u32, SEGD2L_SPEC, u32, u32, 24, O>;
impl R {
    #[doc = "Bits 0:23 - COM2 Segment Data Low"]
    #[inline(always)]
    pub fn segd2l(&self) -> SEGD2L_R {
        SEGD2L_R::new(self.bits & 0x00ff_ffff)
    }
}
impl W {
    #[doc = "Bits 0:23 - COM2 Segment Data Low"]
    #[inline(always)]
    #[must_use]
    pub fn segd2l(&mut self) -> SEGD2L_W<0> {
        SEGD2L_W::new(self)
    }
