...
pub type EDGE_W<'a> = crate::BitWriter<'a, u32, IFS_SPEC, bool, 0>;
#[doc = "Field `WARMUP` writer - Set WARMUP Interrupt Flag"]
pub type WARMUP_W<'a> = crate::BitWriter<'a, u32, IFS_SPEC, bool, 1>;
#[doc = "Field `APORTCONFLICT` writer - Set APORTCONFLICT Interrupt Flag"]
pub type APORTCONFLICT_W<'a> = crate::BitWriter<'a, u32, IFS_SPEC, bool, 2>;
impl W {
