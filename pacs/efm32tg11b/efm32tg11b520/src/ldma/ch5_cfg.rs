...
pub type ARBSLOTS_W<'a> = crate::FieldWriterSafe<'a, u32, CH5_CFG_SPEC, u8, ARBSLOTS_A, 2, 16>;
impl<'a> ARBSLOTS_W<'a> {
...
pub type SRCINCSIGN_W<'a> = crate::BitWriter<'a, u32, CH5_CFG_SPEC, bool, 20>;
...
pub type DSTINCSIGN_W<'a> = crate::BitWriter<'a, u32, CH5_CFG_SPEC, bool, 21>;
impl R {
