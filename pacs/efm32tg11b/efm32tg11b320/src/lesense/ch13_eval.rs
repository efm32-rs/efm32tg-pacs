#[doc = "Register `CH13_EVAL` reader"]
pub struct R(crate::R<CH13_EVAL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CH13_EVAL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CH13_EVAL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CH13_EVAL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CH13_EVAL` writer"]
pub struct W(crate::W<CH13_EVAL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CH13_EVAL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CH13_EVAL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CH13_EVAL_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type COMPTHRES_W<'a> = crate::FieldWriter<'a, u32, CH13_EVAL_SPEC, u16, u16, 16, 0>;
...
pub type COMP_W<'a> = crate::BitWriter<'a, u32, CH13_EVAL_SPEC, bool, 16>;
...
pub type DECODE_W<'a> = crate::BitWriter<'a, u32, CH13_EVAL_SPEC, bool, 17>;
...
pub type STRSAMPLE_W<'a> = crate::FieldWriter<'a, u32, CH13_EVAL_SPEC, u8, STRSAMPLE_A, 2, 18>;
...
pub type SCANRESINV_W<'a> = crate::BitWriter<'a, u32, CH13_EVAL_SPEC, bool, 20>;
...
pub type MODE_W<'a> = crate::FieldWriter<'a, u32, CH13_EVAL_SPEC, u8, MODE_A, 2, 21>;
impl<'a> MODE_W<'a> {
...
#[doc = "Scan Configuration\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [ch13_eval](index.html) module"]
pub struct CH13_EVAL_SPEC;
impl crate::RegisterSpec for CH13_EVAL_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [ch13_eval::R](R) reader structure"]
impl crate::Readable for CH13_EVAL_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [ch13_eval::W](W) writer structure"]
impl crate::Writable for CH13_EVAL_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets CH13_EVAL to value 0"]
impl crate::Resettable for CH13_EVAL_SPEC {
    #[inline(always)]
