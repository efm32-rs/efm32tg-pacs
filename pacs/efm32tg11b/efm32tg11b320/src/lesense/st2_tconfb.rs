...
pub type NEXTSTATE_W<'a> = crate::FieldWriter<'a, u32, ST2_TCONFB_SPEC, u8, u8, 5, 8>;
#[doc = "Field `SETIF` reader - Set Interrupt Flag"]
pub type SETIF_R = crate::BitReader<bool>;
#[doc = "Field `SETIF` writer - Set Interrupt Flag"]
pub type SETIF_W<'a> = crate::BitWriter<'a, u32, ST2_TCONFB_SPEC, bool, 15>;
...
pub type PRSACT_W<'a> = crate::FieldWriter<'a, u32, ST2_TCONFB_SPEC, u8, u8, 3, 16>;
impl R {
