#[doc = "Register `CH1_CFG` reader"]
pub struct R(crate::R<CH1_CFG_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CH1_CFG_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CH1_CFG_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CH1_CFG_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CH1_CFG` writer"]
pub struct W(crate::W<CH1_CFG_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CH1_CFG_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CH1_CFG_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CH1_CFG_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type ARBSLOTS_W<'a> = crate::FieldWriterSafe<'a, u32, CH1_CFG_SPEC, u8, ARBSLOTS_A, 2, 16>;
impl<'a> ARBSLOTS_W<'a> {
...
pub type SRCINCSIGN_W<'a> = crate::BitWriter<'a, u32, CH1_CFG_SPEC, bool, 20>;
...
pub type DSTINCSIGN_W<'a> = crate::BitWriter<'a, u32, CH1_CFG_SPEC, bool, 21>;
impl R {
...
pub struct CH1_CFG_SPEC;
impl crate::RegisterSpec for CH1_CFG_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [ch1_cfg::R](R) reader structure"]
impl crate::Readable for CH1_CFG_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [ch1_cfg::W](W) writer structure"]
impl crate::Writable for CH1_CFG_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets CH1_CFG to value 0"]
impl crate::Resettable for CH1_CFG_SPEC {
    #[inline(always)]
