...
pub struct R(crate::R<OPA0_MUX_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<OPA0_MUX_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<OPA0_MUX_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<OPA0_MUX_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `OPA0_MUX` writer"]
pub struct W(crate::W<OPA0_MUX_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<OPA0_MUX_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<OPA0_MUX_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<OPA0_MUX_SPEC>) -> Self {
        W(writer)
    }
}
