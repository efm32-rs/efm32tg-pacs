...
pub type RETDIS_W<'a> = crate::BitWriter<'a, u32, VMONIO0CTRL_SPEC, bool, 4>;
...
pub type THRESFINE_W<'a> = crate::FieldWriter<'a, u32, VMONIO0CTRL_SPEC, u8, u8, 4, 8>;
...
pub type THRESCOARSE_W<'a> = crate::FieldWriter<'a, u32, VMONIO0CTRL_SPEC, u8, u8, 4, 12>;
impl R {
    #[doc = "Bit 0 - Enable"]
    #[inline(always)]
    pub fn en(&self) -> EN_R {
