...
pub type TCMPVAL_W<'a> = crate::FieldWriter<'a, u32, TIMECMP1_SPEC, u8, u8, 8, 0>;
...
pub type TSTART_W<'a> = crate::FieldWriter<'a, u32, TIMECMP1_SPEC, u8, TSTART_A, 3, 16>;
impl<'a> TSTART_W<'a> {
...
pub type TSTOP_W<'a> = crate::FieldWriter<'a, u32, TIMECMP1_SPEC, u8, TSTOP_A, 3, 20>;
impl<'a> TSTOP_W<'a> {
...
pub type RESTARTEN_W<'a> = crate::BitWriter<'a, u32, TIMECMP1_SPEC, bool, 24>;
impl R {
