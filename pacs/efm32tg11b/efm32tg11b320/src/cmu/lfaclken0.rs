...
pub type LETIMER0_W<'a> = crate::BitWriter<'a, u32, LFACLKEN0_SPEC, bool, 1>;
...
pub type LCD_W<'a> = crate::BitWriter<'a, u32, LFACLKEN0_SPEC, bool, 2>;
impl R {
    ...
    #[doc = "Bit 1 - Low Energy Timer 0 Clock Enable"]
    #[inline(always)]
    pub fn letimer0(&self) -> LETIMER0_R {
        LETIMER0_R::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bit 2 - Liquid Crystal Display Controller Clock Enable"]
    #[inline(always)]
