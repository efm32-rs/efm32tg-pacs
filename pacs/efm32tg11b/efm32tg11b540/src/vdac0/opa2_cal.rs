...
pub type CM1_W<'a> = crate::FieldWriter<'a, u32, OPA2_CAL_SPEC, u8, u8, 4, 0>;
...
pub type CM2_W<'a> = crate::FieldWriter<'a, u32, OPA2_CAL_SPEC, u8, u8, 4, 5>;
...
pub type OFFSETP_W<'a> = crate::FieldWriter<'a, u32, OPA2_CAL_SPEC, u8, u8, 5, 20>;
...
pub type OFFSETN_W<'a> = crate::FieldWriter<'a, u32, OPA2_CAL_SPEC, u8, u8, 5, 26>;
impl R {
