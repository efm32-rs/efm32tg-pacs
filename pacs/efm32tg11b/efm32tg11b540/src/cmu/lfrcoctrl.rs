...
pub type TUNING_W<'a> = crate::FieldWriter<'a, u32, LFRCOCTRL_SPEC, u16, u16, 9, 0>;
...
pub type ENVREF_W<'a> = crate::BitWriter<'a, u32, LFRCOCTRL_SPEC, bool, 16>;
...
pub type ENCHOP_W<'a> = crate::BitWriter<'a, u32, LFRCOCTRL_SPEC, bool, 17>;
...
pub type ENDEM_W<'a> = crate::BitWriter<'a, u32, LFRCOCTRL_SPEC, bool, 18>;
...
pub type VREFUPDATE_W<'a> =
    crate::FieldWriterSafe<'a, u32, LFRCOCTRL_SPEC, u8, VREFUPDATE_A, 2, 20>;
...
pub type TIMEOUT_W<'a> = crate::FieldWriter<'a, u32, LFRCOCTRL_SPEC, u8, TIMEOUT_A, 2, 24>;
impl<'a> TIMEOUT_W<'a> {
...
pub type GMCCURTUNE_W<'a> = crate::FieldWriter<'a, u32, LFRCOCTRL_SPEC, u8, u8, 4, 28>;
impl R {
