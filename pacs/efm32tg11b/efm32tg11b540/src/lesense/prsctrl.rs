...
pub type DECCMPVAL_W<'a> = crate::FieldWriter<'a, u32, PRSCTRL_SPEC, u8, u8, 5, 0>;
...
pub type DECCMPMASK_W<'a> = crate::FieldWriter<'a, u32, PRSCTRL_SPEC, u8, u8, 5, 8>;
...
pub type DECCMPEN_W<'a> = crate::BitWriter<'a, u32, PRSCTRL_SPEC, bool, 16>;
impl R {
