#[doc = "Register `OPA3_MUX` reader"]
pub struct R(crate::R<OPA3_MUX_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<OPA3_MUX_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<OPA3_MUX_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<OPA3_MUX_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `OPA3_MUX` writer"]
pub struct W(crate::W<OPA3_MUX_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<OPA3_MUX_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<OPA3_MUX_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<OPA3_MUX_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type POSSEL_W<'a> = crate::FieldWriter<'a, u32, OPA3_MUX_SPEC, u8, u8, 8, 0>;
...
pub type NEGSEL_W<'a> = crate::FieldWriter<'a, u32, OPA3_MUX_SPEC, u8, u8, 8, 8>;
...
pub type RESINMUX_W<'a> = crate::FieldWriter<'a, u32, OPA3_MUX_SPEC, u8, RESINMUX_A, 3, 16>;
impl<'a> RESINMUX_W<'a> {
...
pub type GAIN3X_W<'a> = crate::BitWriter<'a, u32, OPA3_MUX_SPEC, bool, 20>;
...
pub type RESSEL_W<'a> = crate::FieldWriterSafe<'a, u32, OPA3_MUX_SPEC, u8, RESSEL_A, 3, 24>;
impl<'a> RESSEL_W<'a> {
    #[doc = "Gain of 1/3"]
    #[inline(always)]
...
#[doc = "Operational Amplifier Mux Configuration Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [opa3_mux](index.html) module"]
pub struct OPA3_MUX_SPEC;
impl crate::RegisterSpec for OPA3_MUX_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [opa3_mux::R](R) reader structure"]
impl crate::Readable for OPA3_MUX_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [opa3_mux::W](W) writer structure"]
impl crate::Writable for OPA3_MUX_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets OPA3_MUX to value 0x0016_f2f1"]
impl crate::Resettable for OPA3_MUX_SPEC {
    #[inline(always)]
