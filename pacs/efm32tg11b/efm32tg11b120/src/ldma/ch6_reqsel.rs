...
pub struct R(crate::R<CH6_REQSEL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CH6_REQSEL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CH6_REQSEL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CH6_REQSEL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CH6_REQSEL` writer"]
pub struct W(crate::W<CH6_REQSEL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CH6_REQSEL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CH6_REQSEL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CH6_REQSEL_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type SIGSEL_W<'a> = crate::FieldWriter<'a, u32, CH6_REQSEL_SPEC, u8, u8, 4, 0>;
#[doc = "Source Select\n\nValue on reset: 0"]
...
pub type SOURCESEL_W<'a> = crate::FieldWriter<'a, u32, CH6_REQSEL_SPEC, u8, SOURCESEL_A, 6, 16>;
...
pub struct CH6_REQSEL_SPEC;
impl crate::RegisterSpec for CH6_REQSEL_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [ch6_reqsel::R](R) reader structure"]
impl crate::Readable for CH6_REQSEL_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [ch6_reqsel::W](W) writer structure"]
impl crate::Writable for CH6_REQSEL_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets CH6_REQSEL to value 0"]
impl crate::Resettable for CH6_REQSEL_SPEC {
    #[inline(always)]
