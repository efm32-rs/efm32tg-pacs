...
pub type DOWNSEL_W<'a> = crate::FieldWriter<'a, u32, CALCTRL_SPEC, u8, DOWNSEL_A, 3, 4>;
impl<'a> DOWNSEL_W<'a> {
...
pub type PRSUPSEL_W<'a> = crate::FieldWriterSafe<'a, u32, CALCTRL_SPEC, u8, PRSUPSEL_A, 3, 16>;
impl<'a> PRSUPSEL_W<'a> {
...
pub type PRSDOWNSEL_W<'a> = crate::FieldWriterSafe<'a, u32, CALCTRL_SPEC, u8, PRSDOWNSEL_A, 3, 24>;
