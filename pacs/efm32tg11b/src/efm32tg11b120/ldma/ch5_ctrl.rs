...
pub type STRUCTREQ_W<'a, const O: u8> = crate::BitWriter<'a, u32, CH5_CTRL_SPEC, bool, O>;
...
pub type DONEIFSEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, CH5_CTRL_SPEC, bool, O>;
...
pub type REQMODE_W<'a, const O: u8> = crate::BitWriter<'a, u32, CH5_CTRL_SPEC, bool, O>;
