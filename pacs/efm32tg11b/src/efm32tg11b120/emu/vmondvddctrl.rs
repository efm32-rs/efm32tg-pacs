...
pub type EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, VMONDVDDCTRL_SPEC, bool, O>;
#[doc = "Field `RISEWU` reader - Rise Wakeup"]
pub type RISEWU_R = crate::BitReader<bool>;
#[doc = "Field `RISEWU` writer - Rise Wakeup"]
pub type RISEWU_W<'a, const O: u8> = crate::BitWriter<'a, u32, VMONDVDDCTRL_SPEC, bool, O>;
#[doc = "Field `FALLWU` reader - Fall Wakeup"]
pub type FALLWU_R = crate::BitReader<bool>;
#[doc = "Field `FALLWU` writer - Fall Wakeup"]
pub type FALLWU_W<'a, const O: u8> = crate::BitWriter<'a, u32, VMONDVDDCTRL_SPEC, bool, O>;
...
pub type THRESFINE_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, VMONDVDDCTRL_SPEC, u8, u8, 4, O>;
