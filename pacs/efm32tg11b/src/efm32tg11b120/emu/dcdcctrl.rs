...
pub type DCDCMODE_W<'a> = crate::FieldWriterSafe<'a, u32, DCDCCTRL_SPEC, u8, DCDCMODE_A, 2, 0>;
impl<'a> DCDCMODE_W<'a> {
...
pub type DCDCMODEEM23_W<'a> = crate::BitWriter<'a, u32, DCDCCTRL_SPEC, bool, 4>;
...
pub type DCDCMODEEM4_W<'a> = crate::BitWriter<'a, u32, DCDCCTRL_SPEC, bool, 5>;
impl R {
