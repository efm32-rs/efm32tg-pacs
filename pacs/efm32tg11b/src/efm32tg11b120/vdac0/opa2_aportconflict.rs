#[doc = "Register `OPA2_APORTCONFLICT` reader"]
pub struct R(crate::R<OPA2_APORTCONFLICT_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<OPA2_APORTCONFLICT_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<OPA2_APORTCONFLICT_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<OPA2_APORTCONFLICT_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Operational Amplifier APORT Conflict Status Register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [opa2_aportconflict](index.html) module"]
pub struct OPA2_APORTCONFLICT_SPEC;
impl crate::RegisterSpec for OPA2_APORTCONFLICT_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [opa2_aportconflict::R](R) reader structure"]
impl crate::Readable for OPA2_APORTCONFLICT_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets OPA2_APORTCONFLICT to value 0"]
impl crate::Resettable for OPA2_APORTCONFLICT_SPEC {
