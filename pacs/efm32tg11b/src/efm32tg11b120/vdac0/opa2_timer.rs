...
pub struct R(crate::R<OPA2_TIMER_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<OPA2_TIMER_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<OPA2_TIMER_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<OPA2_TIMER_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `OPA2_TIMER` writer"]
pub struct W(crate::W<OPA2_TIMER_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<OPA2_TIMER_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<OPA2_TIMER_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<OPA2_TIMER_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type STARTUPDLY_W<'a> = crate::FieldWriter<'a, u32, OPA2_TIMER_SPEC, u8, u8, 6, 0>;
...
pub type WARMUPTIME_W<'a> = crate::FieldWriter<'a, u32, OPA2_TIMER_SPEC, u8, u8, 7, 8>;
...
pub type SETTLETIME_W<'a> = crate::FieldWriter<'a, u32, OPA2_TIMER_SPEC, u16, u16, 10, 16>;
impl R {
