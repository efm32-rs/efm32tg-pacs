#[doc = "Register `OPA1_APORTREQ` reader"]
pub struct R(crate::R<OPA1_APORTREQ_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<OPA1_APORTREQ_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<OPA1_APORTREQ_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<OPA1_APORTREQ_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Operational Amplifier APORT Request Status Register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [opa1_aportreq](index.html) module"]
pub struct OPA1_APORTREQ_SPEC;
impl crate::RegisterSpec for OPA1_APORTREQ_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [opa1_aportreq::R](R) reader structure"]
impl crate::Readable for OPA1_APORTREQ_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets OPA1_APORTREQ to value 0"]
impl crate::Resettable for OPA1_APORTREQ_SPEC {
