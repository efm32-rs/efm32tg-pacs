#[doc = "Register `OPA1_CAL` reader"]
pub struct R(crate::R<OPA1_CAL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<OPA1_CAL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<OPA1_CAL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<OPA1_CAL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `OPA1_CAL` writer"]
pub struct W(crate::W<OPA1_CAL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<OPA1_CAL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<OPA1_CAL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<OPA1_CAL_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type CM1_W<'a, const O: u8> = crate::FieldWriter<'a, u32, OPA1_CAL_SPEC, u8, u8, 4, O>;
...
pub type CM2_W<'a, const O: u8> = crate::FieldWriter<'a, u32, OPA1_CAL_SPEC, u8, u8, 4, O>;
...
pub type CM3_W<'a, const O: u8> = crate::FieldWriter<'a, u32, OPA1_CAL_SPEC, u8, u8, 2, O>;
#[doc = "Field `GM` reader - Gm Trim Value"]
pub type GM_R = crate::FieldReader<u8, u8>;
#[doc = "Field `GM` writer - Gm Trim Value"]
pub type GM_W<'a, const O: u8> = crate::FieldWriter<'a, u32, OPA1_CAL_SPEC, u8, u8, 3, O>;
#[doc = "Field `GM3` reader - Gm3 Trim Value"]
pub type GM3_R = crate::FieldReader<u8, u8>;
#[doc = "Field `GM3` writer - Gm3 Trim Value"]
pub type GM3_W<'a, const O: u8> = crate::FieldWriter<'a, u32, OPA1_CAL_SPEC, u8, u8, 2, O>;
...
pub type OFFSETP_W<'a, const O: u8> = crate::FieldWriter<'a, u32, OPA1_CAL_SPEC, u8, u8, 5, O>;
...
pub type OFFSETN_W<'a, const O: u8> = crate::FieldWriter<'a, u32, OPA1_CAL_SPEC, u8, u8, 5, O>;
impl R {
...
pub struct OPA1_CAL_SPEC;
impl crate::RegisterSpec for OPA1_CAL_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [opa1_cal::R](R) reader structure"]
impl crate::Readable for OPA1_CAL_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [opa1_cal::W](W) writer structure"]
impl crate::Writable for OPA1_CAL_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets OPA1_CAL to value 0x80e7"]
impl crate::Resettable for OPA1_CAL_SPEC {
