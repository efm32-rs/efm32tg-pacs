...
pub type MODE0_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, PK_MODEL_SPEC, u8, MODE0_A, 4, O>;
...
pub type MODE1_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, PK_MODEL_SPEC, u8, MODE1_A, 4, O>;
...
pub type MODE2_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, PK_MODEL_SPEC, u8, MODE2_A, 4, O>;
...
pub type MODE3_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, PK_MODEL_SPEC, u8, MODE3_A, 4, O>;
...
pub type MODE4_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, PK_MODEL_SPEC, u8, MODE4_A, 4, O>;
...
pub type MODE5_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, PK_MODEL_SPEC, u8, MODE5_A, 4, O>;
...
pub type MODE6_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, PK_MODEL_SPEC, u8, MODE6_A, 4, O>;
...
pub type MODE7_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, PK_MODEL_SPEC, u8, MODE7_A, 4, O>;
