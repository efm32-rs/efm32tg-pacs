...
pub type DRIVESTRENGTH_W<'a, const O: u8> = crate::BitWriter<'a, u32, PE_CTRL_SPEC, bool, O>;
...
pub type SLEWRATE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PE_CTRL_SPEC, u8, u8, 3, O>;
#[doc = "Field `DINDIS` reader - Data in Disable"]
pub type DINDIS_R = crate::BitReader<bool>;
#[doc = "Field `DINDIS` writer - Data in Disable"]
pub type DINDIS_W<'a, const O: u8> = crate::BitWriter<'a, u32, PE_CTRL_SPEC, bool, O>;
...
pub type DRIVESTRENGTHALT_W<'a, const O: u8> = crate::BitWriter<'a, u32, PE_CTRL_SPEC, bool, O>;
...
pub type SLEWRATEALT_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PE_CTRL_SPEC, u8, u8, 3, O>;
...
pub type DINDISALT_W<'a, const O: u8> = crate::BitWriter<'a, u32, PE_CTRL_SPEC, bool, O>;
impl R {
...
#[doc = "`reset()` method sets PE_CTRL to value 0x0050_0050"]
