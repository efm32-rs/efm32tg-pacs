#[doc = "Register `PK_MODEH` reader"]
pub struct R(crate::R<PK_MODEH_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PK_MODEH_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PK_MODEH_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PK_MODEH_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PK_MODEH` writer"]
pub struct W(crate::W<PK_MODEH_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PK_MODEH_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PK_MODEH_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PK_MODEH_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type MODE8_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, PK_MODEH_SPEC, u8, MODE8_A, 4, O>;
...
pub type MODE9_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, PK_MODEH_SPEC, u8, MODE9_A, 4, O>;
...
pub type MODE10_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, PK_MODEH_SPEC, u8, MODE10_A, 4, O>;
...
pub type MODE11_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, PK_MODEH_SPEC, u8, MODE11_A, 4, O>;
...
pub type MODE12_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, PK_MODEH_SPEC, u8, MODE12_A, 4, O>;
...
pub type MODE13_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, PK_MODEH_SPEC, u8, MODE13_A, 4, O>;
...
pub type MODE14_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, PK_MODEH_SPEC, u8, MODE14_A, 4, O>;
...
pub type MODE15_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, PK_MODEH_SPEC, u8, MODE15_A, 4, O>;
...
#[doc = "Port Pin Mode High Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pk_modeh](index.html) module"]
pub struct PK_MODEH_SPEC;
impl crate::RegisterSpec for PK_MODEH_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pk_modeh::R](R) reader structure"]
impl crate::Readable for PK_MODEH_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [pk_modeh::W](W) writer structure"]
impl crate::Writable for PK_MODEH_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets PK_MODEH to value 0"]
impl crate::Resettable for PK_MODEH_SPEC {
