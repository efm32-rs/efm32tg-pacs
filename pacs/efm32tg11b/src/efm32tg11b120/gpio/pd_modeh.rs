...
pub type MODE8_W<'a> = crate::FieldWriterSafe<'a, u32, PD_MODEH_SPEC, u8, MODE8_A, 4, 0>;
impl<'a> MODE8_W<'a> {
...
pub type MODE9_W<'a> = crate::FieldWriterSafe<'a, u32, PD_MODEH_SPEC, u8, MODE9_A, 4, 4>;
impl<'a> MODE9_W<'a> {
    #[doc = "Input disabled. Pullup if DOUT is set."]
    #[inline(always)]
    pub fn disabled(self) -> &'a mut W {
...
pub type MODE10_W<'a> = crate::FieldWriterSafe<'a, u32, PD_MODEH_SPEC, u8, MODE10_A, 4, 8>;
impl<'a> MODE10_W<'a> {
    #[doc = "Input disabled. Pullup if DOUT is set."]
    #[inline(always)]
    pub fn disabled(self) -> &'a mut W {
...
pub type MODE11_W<'a> = crate::FieldWriterSafe<'a, u32, PD_MODEH_SPEC, u8, MODE11_A, 4, 12>;
impl<'a> MODE11_W<'a> {
    #[doc = "Input disabled. Pullup if DOUT is set."]
    #[inline(always)]
    pub fn disabled(self) -> &'a mut W {
...
pub type MODE12_W<'a> = crate::FieldWriterSafe<'a, u32, PD_MODEH_SPEC, u8, MODE12_A, 4, 16>;
impl<'a> MODE12_W<'a> {
    #[doc = "Input disabled. Pullup if DOUT is set."]
    #[inline(always)]
    pub fn disabled(self) -> &'a mut W {
...
pub type MODE13_W<'a> = crate::FieldWriterSafe<'a, u32, PD_MODEH_SPEC, u8, MODE13_A, 4, 20>;
impl<'a> MODE13_W<'a> {
    #[doc = "Input disabled. Pullup if DOUT is set."]
    #[inline(always)]
    pub fn disabled(self) -> &'a mut W {
...
pub type MODE14_W<'a> = crate::FieldWriterSafe<'a, u32, PD_MODEH_SPEC, u8, MODE14_A, 4, 24>;
impl<'a> MODE14_W<'a> {
    #[doc = "Input disabled. Pullup if DOUT is set."]
    #[inline(always)]
    pub fn disabled(self) -> &'a mut W {
...
pub type MODE15_W<'a> = crate::FieldWriterSafe<'a, u32, PD_MODEH_SPEC, u8, MODE15_A, 4, 28>;
impl<'a> MODE15_W<'a> {
    #[doc = "Input disabled. Pullup if DOUT is set."]
    #[inline(always)]
    pub fn disabled(self) -> &'a mut W {
