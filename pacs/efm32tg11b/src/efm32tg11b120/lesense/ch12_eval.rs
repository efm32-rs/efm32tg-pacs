#[doc = "Register `CH12_EVAL` reader"]
pub struct R(crate::R<CH12_EVAL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CH12_EVAL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CH12_EVAL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CH12_EVAL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CH12_EVAL` writer"]
pub struct W(crate::W<CH12_EVAL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CH12_EVAL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CH12_EVAL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CH12_EVAL_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type COMPTHRES_W<'a> = crate::FieldWriter<'a, u32, CH12_EVAL_SPEC, u16, u16, 16, 0>;
...
pub type COMP_W<'a> = crate::BitWriter<'a, u32, CH12_EVAL_SPEC, bool, 16>;
...
pub type DECODE_W<'a> = crate::BitWriter<'a, u32, CH12_EVAL_SPEC, bool, 17>;
...
pub type STRSAMPLE_W<'a> = crate::FieldWriter<'a, u32, CH12_EVAL_SPEC, u8, STRSAMPLE_A, 2, 18>;
...
pub type SCANRESINV_W<'a> = crate::BitWriter<'a, u32, CH12_EVAL_SPEC, bool, 20>;
...
pub type MODE_W<'a> = crate::FieldWriter<'a, u32, CH12_EVAL_SPEC, u8, MODE_A, 2, 21>;
impl<'a> MODE_W<'a> {
...
pub struct CH12_EVAL_SPEC;
impl crate::RegisterSpec for CH12_EVAL_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [ch12_eval::R](R) reader structure"]
impl crate::Readable for CH12_EVAL_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [ch12_eval::W](W) writer structure"]
impl crate::Writable for CH12_EVAL_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets CH12_EVAL to value 0"]
impl crate::Resettable for CH12_EVAL_SPEC {
    #[inline(always)]
