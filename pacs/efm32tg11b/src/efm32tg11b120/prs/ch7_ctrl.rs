...
pub type SIGSEL_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CH7_CTRL_SPEC, u8, u8, 3, O>;
...
pub type SOURCESEL_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CH7_CTRL_SPEC, u8, SOURCESEL_A, 7, O>;
...
pub type EDSEL_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, CH7_CTRL_SPEC, u8, EDSEL_A, 2, O>;
...
pub type ASYNC_W<'a, const O: u8> = crate::BitWriter<'a, u32, CH7_CTRL_SPEC, bool, O>;
impl R {
