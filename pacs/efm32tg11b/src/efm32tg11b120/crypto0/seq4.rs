...
pub type INSTR16_W<'a> = crate::FieldWriter<'a, u32, SEQ4_SPEC, u8, u8, 8, 0>;
...
pub type INSTR17_W<'a> = crate::FieldWriter<'a, u32, SEQ4_SPEC, u8, u8, 8, 8>;
...
pub type INSTR18_W<'a> = crate::FieldWriter<'a, u32, SEQ4_SPEC, u8, u8, 8, 16>;
...
pub type INSTR19_W<'a> = crate::FieldWriter<'a, u32, SEQ4_SPEC, u8, u8, 8, 24>;
impl R {
