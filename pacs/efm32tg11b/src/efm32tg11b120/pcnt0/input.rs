...
pub type S0PRSSEL_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, INPUT_SPEC, u8, S0PRSSEL_A, 3, O>;
...
pub type S1PRSSEL_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, INPUT_SPEC, u8, S1PRSSEL_A, 3, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn s0prsen(&mut self) -> S0PRSEN_W<5> {
        S0PRSEN_W::new(self)
    }
    #[doc = "Bits 6:8 - S1IN PRS Channel Select"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn s1prsen(&mut self) -> S1PRSEN_W<11> {
        S1PRSEN_W::new(self)
    }
