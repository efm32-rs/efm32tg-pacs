...
pub struct R(crate::R<MIR1_CMDREQ_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<MIR1_CMDREQ_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<MIR1_CMDREQ_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<MIR1_CMDREQ_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `MIR1_CMDREQ` writer"]
pub struct W(crate::W<MIR1_CMDREQ_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<MIR1_CMDREQ_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<MIR1_CMDREQ_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<MIR1_CMDREQ_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type MSGNUM_W<'a, const O: u8> = crate::FieldWriter<'a, u32, MIR1_CMDREQ_SPEC, u8, u8, 6, O>;
