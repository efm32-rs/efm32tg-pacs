...
pub type DISSYNCOUT_R = crate::BitReader<bool>;
#[doc = "Field `DISSYNCOUT` writer - Disable Timer From Start/Stop/Reload Other Synchronized Timers"]
pub type DISSYNCOUT_W<'a, const O: u8> = crate::BitWriter<'a, u32, CTRL_SPEC, bool, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dissyncout(&mut self) -> DISSYNCOUT_W<14> {
