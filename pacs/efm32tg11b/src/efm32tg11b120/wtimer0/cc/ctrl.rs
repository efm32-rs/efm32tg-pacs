...
pub type OUTINV_W<'a, const O: u8> = crate::BitWriter<'a, u32, CTRL_SPEC, bool, O>;
...
pub type COIST_W<'a, const O: u8> = crate::BitWriter<'a, u32, CTRL_SPEC, bool, O>;
...
pub type CMOA_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u32, CTRL_SPEC, u8, CMOA_A, 2, O>;
...
pub type COFOA_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u32, CTRL_SPEC, u8, COFOA_A, 2, O>;
...
pub type CUFOA_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u32, CTRL_SPEC, u8, CUFOA_A, 2, O>;
...
pub type PRSSEL_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u32, CTRL_SPEC, u8, PRSSEL_A, 3, O>;
...
pub type ICEDGE_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u32, CTRL_SPEC, u8, ICEDGE_A, 2, O>;
...
pub type ICEVCTRL_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, CTRL_SPEC, u8, ICEVCTRL_A, 2, O>;
...
pub type PRSCONF_W<'a, const O: u8> = crate::BitWriter<'a, u32, CTRL_SPEC, bool, O>;
#[doc = "Field `INSEL` reader - Input Selection"]
pub type INSEL_R = crate::BitReader<bool>;
#[doc = "Field `INSEL` writer - Input Selection"]
pub type INSEL_W<'a, const O: u8> = crate::BitWriter<'a, u32, CTRL_SPEC, bool, O>;
