...
#[doc = "Field `DPLLEN` writer - DPLL Enable"]
pub type DPLLEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, OSCENCMD_SPEC, bool, O>;
#[doc = "Field `DPLLDIS` writer - DPLL Disable"]
pub type DPLLDIS_W<'a, const O: u8> = crate::BitWriter<'a, u32, OSCENCMD_SPEC, bool, O>;
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dpllen(&mut self) -> DPLLEN_W<12> {
        DPLLEN_W::new(self)
    }
    #[doc = "Bit 13 - DPLL Disable"]
    #[inline(always)]
    #[must_use]
    pub fn dplldis(&mut self) -> DPLLDIS_W<13> {
        DPLLDIS_W::new(self)
    }
