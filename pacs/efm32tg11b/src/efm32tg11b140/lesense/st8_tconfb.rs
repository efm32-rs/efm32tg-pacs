...
pub struct R(crate::R<ST8_TCONFB_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<ST8_TCONFB_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<ST8_TCONFB_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<ST8_TCONFB_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `ST8_TCONFB` writer"]
pub struct W(crate::W<ST8_TCONFB_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<ST8_TCONFB_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<ST8_TCONFB_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<ST8_TCONFB_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type COMP_W<'a, const O: u8> = crate::FieldWriter<'a, u32, ST8_TCONFB_SPEC, u8, u8, 4, O>;
#[doc = "Field `MASK` reader - Sensor Mask"]
pub type MASK_R = crate::FieldReader<u8, u8>;
#[doc = "Field `MASK` writer - Sensor Mask"]
pub type MASK_W<'a, const O: u8> = crate::FieldWriter<'a, u32, ST8_TCONFB_SPEC, u8, u8, 4, O>;
...
pub type NEXTSTATE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, ST8_TCONFB_SPEC, u8, u8, 5, O>;
#[doc = "Field `SETIF` reader - Set Interrupt Flag"]
pub type SETIF_R = crate::BitReader<bool>;
#[doc = "Field `SETIF` writer - Set Interrupt Flag"]
pub type SETIF_W<'a, const O: u8> = crate::BitWriter<'a, u32, ST8_TCONFB_SPEC, bool, O>;
...
pub type PRSACT_W<'a, const O: u8> = crate::FieldWriter<'a, u32, ST8_TCONFB_SPEC, u8, u8, 3, O>;
impl R {
