#[doc = "Register `ST9_TCONFB` reader"]
pub struct R(crate::R<ST9_TCONFB_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<ST9_TCONFB_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<ST9_TCONFB_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<ST9_TCONFB_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `ST9_TCONFB` writer"]
pub struct W(crate::W<ST9_TCONFB_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<ST9_TCONFB_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<ST9_TCONFB_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<ST9_TCONFB_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type NEXTSTATE_W<'a> = crate::FieldWriter<'a, u32, ST9_TCONFB_SPEC, u8, u8, 5, 8>;
#[doc = "Field `SETIF` reader - Set Interrupt Flag"]
pub type SETIF_R = crate::BitReader<bool>;
#[doc = "Field `SETIF` writer - Set Interrupt Flag"]
pub type SETIF_W<'a> = crate::BitWriter<'a, u32, ST9_TCONFB_SPEC, bool, 15>;
...
pub type PRSACT_W<'a> = crate::FieldWriter<'a, u32, ST9_TCONFB_SPEC, u8, u8, 3, 16>;
impl R {
...
#[doc = "State Transition Configuration B\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [st9_tconfb](index.html) module"]
pub struct ST9_TCONFB_SPEC;
impl crate::RegisterSpec for ST9_TCONFB_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [st9_tconfb::R](R) reader structure"]
impl crate::Readable for ST9_TCONFB_SPEC {
    type Reader = R;
}
