#[doc = "Register `OPA3_APORTREQ` reader"]
pub struct R(crate::R<OPA3_APORTREQ_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<OPA3_APORTREQ_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<OPA3_APORTREQ_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<OPA3_APORTREQ_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Operational Amplifier APORT Request Status Register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [opa3_aportreq](index.html) module"]
pub struct OPA3_APORTREQ_SPEC;
impl crate::RegisterSpec for OPA3_APORTREQ_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [opa3_aportreq::R](R) reader structure"]
impl crate::Readable for OPA3_APORTREQ_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets OPA3_APORTREQ to value 0"]
impl crate::Resettable for OPA3_APORTREQ_SPEC {
