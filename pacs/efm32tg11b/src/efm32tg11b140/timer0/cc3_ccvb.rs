...
pub struct R(crate::R<CC3_CCVB_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CC3_CCVB_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CC3_CCVB_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CC3_CCVB_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CC3_CCVB` writer"]
pub struct W(crate::W<CC3_CCVB_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CC3_CCVB_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CC3_CCVB_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CC3_CCVB_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type CCVB_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CC3_CCVB_SPEC, u32, u32, 32, O>;
impl R {
