...
pub type MODE_W<'a> = crate::FieldWriter<'a, u32, CC2_CTRL_SPEC, u8, MODE_A, 2, 0>;
impl<'a> MODE_W<'a> {
...
pub type CMOA_W<'a> = crate::FieldWriterSafe<'a, u32, CC2_CTRL_SPEC, u8, CMOA_A, 2, 2>;
impl<'a> CMOA_W<'a> {
...
pub type ICEDGE_W<'a> = crate::FieldWriterSafe<'a, u32, CC2_CTRL_SPEC, u8, ICEDGE_A, 2, 4>;
impl<'a> ICEDGE_W<'a> {
...
pub type PRSSEL_W<'a> = crate::FieldWriterSafe<'a, u32, CC2_CTRL_SPEC, u8, PRSSEL_A, 3, 6>;
impl<'a> PRSSEL_W<'a> {
...
pub type COMPBASE_W<'a> = crate::BitWriter<'a, u32, CC2_CTRL_SPEC, bool, 11>;
...
pub type COMPMASK_W<'a> = crate::FieldWriter<'a, u32, CC2_CTRL_SPEC, u8, u8, 5, 12>;
...
pub type DAYCC_W<'a> = crate::BitWriter<'a, u32, CC2_CTRL_SPEC, bool, 17>;
impl R {
