...
pub struct R(crate::R<OPA3_APORTCONFLICT_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<OPA3_APORTCONFLICT_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<OPA3_APORTCONFLICT_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<OPA3_APORTCONFLICT_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Operational Amplifier APORT Conflict Status Register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [opa3_aportconflict](index.html) module"]
