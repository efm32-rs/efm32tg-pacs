...
pub type POSSEL_W<'a> = crate::FieldWriter<'a, u32, OPA2_MUX_SPEC, u8, u8, 8, 0>;
...
pub type NEGSEL_W<'a> = crate::FieldWriter<'a, u32, OPA2_MUX_SPEC, u8, u8, 8, 8>;
...
pub type RESINMUX_W<'a> = crate::FieldWriter<'a, u32, OPA2_MUX_SPEC, u8, RESINMUX_A, 3, 16>;
impl<'a> RESINMUX_W<'a> {
...
pub type GAIN3X_W<'a> = crate::BitWriter<'a, u32, OPA2_MUX_SPEC, bool, 20>;
...
pub type RESSEL_W<'a> = crate::FieldWriterSafe<'a, u32, OPA2_MUX_SPEC, u8, RESSEL_A, 3, 24>;
impl<'a> RESSEL_W<'a> {
    #[doc = "Gain of 1/3"]
    #[inline(always)]
