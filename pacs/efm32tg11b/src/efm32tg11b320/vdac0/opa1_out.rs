...
pub struct R(crate::R<OPA1_OUT_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<OPA1_OUT_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<OPA1_OUT_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<OPA1_OUT_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `OPA1_OUT` writer"]
pub struct W(crate::W<OPA1_OUT_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<OPA1_OUT_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<OPA1_OUT_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<OPA1_OUT_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type MAINOUTEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, OPA1_OUT_SPEC, bool, O>;
...
pub type ALTOUTEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, OPA1_OUT_SPEC, bool, O>;
...
pub type APORTOUTEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, OPA1_OUT_SPEC, bool, O>;
...
pub type SHORT_W<'a, const O: u8> = crate::BitWriter<'a, u32, OPA1_OUT_SPEC, bool, O>;
...
pub type ALTOUTPADEN_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, OPA1_OUT_SPEC, u8, ALTOUTPADEN_A, 5, O>;
...
pub type APORTOUTSEL_W<'a, const O: u8> = crate::FieldWriter<'a, u32, OPA1_OUT_SPEC, u8, u8, 8, O>;
impl R {
...
#[doc = "Operational Amplifier Output Configuration Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [opa1_out](index.html) module"]
pub struct OPA1_OUT_SPEC;
impl crate::RegisterSpec for OPA1_OUT_SPEC {
    type Ux = u32;
}
