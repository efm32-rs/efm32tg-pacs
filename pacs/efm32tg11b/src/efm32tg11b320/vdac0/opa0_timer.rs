#[doc = "Register `OPA0_TIMER` reader"]
pub struct R(crate::R<OPA0_TIMER_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<OPA0_TIMER_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<OPA0_TIMER_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<OPA0_TIMER_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `OPA0_TIMER` writer"]
pub struct W(crate::W<OPA0_TIMER_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<OPA0_TIMER_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<OPA0_TIMER_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<OPA0_TIMER_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type STARTUPDLY_W<'a> = crate::FieldWriter<'a, u32, OPA0_TIMER_SPEC, u8, u8, 6, 0>;
...
pub type WARMUPTIME_W<'a> = crate::FieldWriter<'a, u32, OPA0_TIMER_SPEC, u8, u8, 7, 8>;
...
pub type SETTLETIME_W<'a> = crate::FieldWriter<'a, u32, OPA0_TIMER_SPEC, u16, u16, 10, 16>;
impl R {
...
#[doc = "Operational Amplifier Timer Control Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [opa0_timer](index.html) module"]
pub struct OPA0_TIMER_SPEC;
impl crate::RegisterSpec for OPA0_TIMER_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [opa0_timer::R](R) reader structure"]
impl crate::Readable for OPA0_TIMER_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [opa0_timer::W](W) writer structure"]
impl crate::Writable for OPA0_TIMER_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets OPA0_TIMER to value 0x0001_0700"]
impl crate::Resettable for OPA0_TIMER_SPEC {
    #[inline(always)]
