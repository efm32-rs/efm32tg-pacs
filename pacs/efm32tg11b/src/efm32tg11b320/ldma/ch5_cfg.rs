...
pub type SRCINCSIGN_W<'a, const O: u8> = crate::BitWriter<'a, u32, CH5_CFG_SPEC, bool, O>;
...
pub type DSTINCSIGN_W<'a, const O: u8> = crate::BitWriter<'a, u32, CH5_CFG_SPEC, bool, O>;
impl R {
