...
pub type COMPTHRES_W<'a> = crate::FieldWriter<'a, u32, CH2_EVAL_SPEC, u16, u16, 16, 0>;
...
pub type COMP_W<'a> = crate::BitWriter<'a, u32, CH2_EVAL_SPEC, bool, 16>;
...
pub type DECODE_W<'a> = crate::BitWriter<'a, u32, CH2_EVAL_SPEC, bool, 17>;
...
pub type STRSAMPLE_W<'a> = crate::FieldWriter<'a, u32, CH2_EVAL_SPEC, u8, STRSAMPLE_A, 2, 18>;
...
pub type SCANRESINV_W<'a> = crate::BitWriter<'a, u32, CH2_EVAL_SPEC, bool, 20>;
...
pub type MODE_W<'a> = crate::FieldWriter<'a, u32, CH2_EVAL_SPEC, u8, MODE_A, 2, 21>;
impl<'a> MODE_W<'a> {
