...
pub struct R(crate::R<ST13_TCONFA_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<ST13_TCONFA_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<ST13_TCONFA_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<ST13_TCONFA_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `ST13_TCONFA` writer"]
pub struct W(crate::W<ST13_TCONFA_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<ST13_TCONFA_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<ST13_TCONFA_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<ST13_TCONFA_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type COMP_W<'a, const O: u8> = crate::FieldWriter<'a, u32, ST13_TCONFA_SPEC, u8, u8, 4, O>;
#[doc = "Field `MASK` reader - Sensor Mask"]
pub type MASK_R = crate::FieldReader<u8, u8>;
#[doc = "Field `MASK` writer - Sensor Mask"]
pub type MASK_W<'a, const O: u8> = crate::FieldWriter<'a, u32, ST13_TCONFA_SPEC, u8, u8, 4, O>;
...
pub type NEXTSTATE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, ST13_TCONFA_SPEC, u8, u8, 5, O>;
...
pub type CHAIN_W<'a, const O: u8> = crate::BitWriter<'a, u32, ST13_TCONFA_SPEC, bool, O>;
...
pub type SETIF_W<'a, const O: u8> = crate::BitWriter<'a, u32, ST13_TCONFA_SPEC, bool, O>;
...
pub type PRSACT_W<'a, const O: u8> = crate::FieldWriter<'a, u32, ST13_TCONFA_SPEC, u8, u8, 3, O>;
impl R {
