...
pub type PRSSEL0_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, DECCTRL_SPEC, u8, PRSSEL0_A, 3, O>;
...
pub type PRSSEL1_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, DECCTRL_SPEC, u8, PRSSEL1_A, 3, O>;
...
pub type PRSSEL2_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, DECCTRL_SPEC, u8, PRSSEL2_A, 3, O>;
...
pub type PRSSEL3_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, DECCTRL_SPEC, u8, PRSSEL3_A, 3, O>;
...
impl R {
    ...
    #[doc = "Bits 10:12 - LESENSE Decoder PRS Input 0 Configuration"]
    #[inline(always)]
    pub fn prssel0(&self) -> PRSSEL0_R {
        PRSSEL0_R::new(((self.bits >> 10) & 7) as u8)
    }
    #[doc = "Bits 15:17 - LESENSE Decoder PRS Input 1 Configuration"]
    #[inline(always)]
    pub fn prssel1(&self) -> PRSSEL1_R {
        PRSSEL1_R::new(((self.bits >> 15) & 7) as u8)
    }
    #[doc = "Bits 20:22 - LESENSE Decoder PRS Input 2 Configuration"]
    #[inline(always)]
    pub fn prssel2(&self) -> PRSSEL2_R {
        PRSSEL2_R::new(((self.bits >> 20) & 7) as u8)
    }
    #[doc = "Bits 25:27 - LESENSE Decoder PRS Input 3 Configuration"]
    #[inline(always)]
    pub fn prssel3(&self) -> PRSSEL3_R {
        PRSSEL3_R::new(((self.bits >> 25) & 7) as u8)
    }
}
impl W {
    #[doc = "Bit 0 - Disable the Decoder"]
    ...
    #[inline(always)]
    #[must_use]
    pub fn prssel1(&mut self) -> PRSSEL1_W<15> {
        PRSSEL1_W::new(self)
    }
    #[doc = "Bits 20:22 - LESENSE Decoder PRS Input 2 Configuration"]
    #[inline(always)]
    #[must_use]
    pub fn prssel2(&mut self) -> PRSSEL2_W<20> {
        PRSSEL2_W::new(self)
    }
    #[doc = "Bits 25:27 - LESENSE Decoder PRS Input 3 Configuration"]
    #[inline(always)]
    #[must_use]
    pub fn prssel3(&mut self) -> PRSSEL3_W<25> {
        PRSSEL3_W::new(self)
    }
