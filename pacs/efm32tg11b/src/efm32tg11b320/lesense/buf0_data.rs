...
pub struct R(crate::R<BUF0_DATA_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<BUF0_DATA_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<BUF0_DATA_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<BUF0_DATA_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `BUF0_DATA` writer"]
pub struct W(crate::W<BUF0_DATA_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<BUF0_DATA_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<BUF0_DATA_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<BUF0_DATA_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Scan Results\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [buf0_data](index.html) module"]
pub struct BUF0_DATA_SPEC;
impl crate::RegisterSpec for BUF0_DATA_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [buf0_data::R](R) reader structure"]
impl crate::Readable for BUF0_DATA_SPEC {
    type Reader = R;
}
