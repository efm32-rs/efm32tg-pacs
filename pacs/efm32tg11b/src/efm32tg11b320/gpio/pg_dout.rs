...
pub struct R(crate::R<PG_DOUT_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PG_DOUT_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PG_DOUT_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PG_DOUT_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PG_DOUT` writer"]
pub struct W(crate::W<PG_DOUT_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PG_DOUT_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PG_DOUT_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PG_DOUT_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type DOUT_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PG_DOUT_SPEC, u16, u16, 16, O>;
impl R {
