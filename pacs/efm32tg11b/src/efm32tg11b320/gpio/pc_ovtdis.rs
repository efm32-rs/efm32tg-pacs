...
pub struct R(crate::R<PC_OVTDIS_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PC_OVTDIS_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PC_OVTDIS_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PC_OVTDIS_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PC_OVTDIS` writer"]
pub struct W(crate::W<PC_OVTDIS_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PC_OVTDIS_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PC_OVTDIS_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PC_OVTDIS_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type OVTDIS_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PC_OVTDIS_SPEC, u16, u16, 16, O>;
impl R {
