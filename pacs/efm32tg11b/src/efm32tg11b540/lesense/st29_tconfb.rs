#[doc = "Register `ST29_TCONFB` reader"]
pub struct R(crate::R<ST29_TCONFB_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<ST29_TCONFB_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<ST29_TCONFB_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<ST29_TCONFB_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `ST29_TCONFB` writer"]
pub struct W(crate::W<ST29_TCONFB_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<ST29_TCONFB_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<ST29_TCONFB_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<ST29_TCONFB_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type COMP_W<'a, const O: u8> = crate::FieldWriter<'a, u32, ST29_TCONFB_SPEC, u8, u8, 4, O>;
#[doc = "Field `MASK` reader - Sensor Mask"]
pub type MASK_R = crate::FieldReader<u8, u8>;
#[doc = "Field `MASK` writer - Sensor Mask"]
pub type MASK_W<'a, const O: u8> = crate::FieldWriter<'a, u32, ST29_TCONFB_SPEC, u8, u8, 4, O>;
...
pub type NEXTSTATE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, ST29_TCONFB_SPEC, u8, u8, 5, O>;
#[doc = "Field `SETIF` reader - Set Interrupt Flag"]
pub type SETIF_R = crate::BitReader<bool>;
#[doc = "Field `SETIF` writer - Set Interrupt Flag"]
pub type SETIF_W<'a, const O: u8> = crate::BitWriter<'a, u32, ST29_TCONFB_SPEC, bool, O>;
...
pub type PRSACT_W<'a, const O: u8> = crate::FieldWriter<'a, u32, ST29_TCONFB_SPEC, u8, u8, 3, O>;
impl R {
...
#[doc = "State Transition Configuration B\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [st29_tconfb](index.html) module"]
pub struct ST29_TCONFB_SPEC;
impl crate::RegisterSpec for ST29_TCONFB_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [st29_tconfb::R](R) reader structure"]
impl crate::Readable for ST29_TCONFB_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [st29_tconfb::W](W) writer structure"]
impl crate::Writable for ST29_TCONFB_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets ST29_TCONFB to value 0"]
impl crate::Resettable for ST29_TCONFB_SPEC {
