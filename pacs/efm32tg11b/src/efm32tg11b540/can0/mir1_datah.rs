...
pub struct R(crate::R<MIR1_DATAH_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<MIR1_DATAH_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<MIR1_DATAH_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<MIR1_DATAH_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `MIR1_DATAH` writer"]
pub struct W(crate::W<MIR1_DATAH_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<MIR1_DATAH_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<MIR1_DATAH_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<MIR1_DATAH_SPEC>) -> Self {
        W(writer)
    }
}
