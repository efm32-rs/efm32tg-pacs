...
pub struct W(crate::W<PH_DOUTTGL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PH_DOUTTGL_SPEC>;
    #[inline(always)]
...
impl From<crate::W<PH_DOUTTGL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PH_DOUTTGL_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `DOUTTGL` writer - Data Out Toggle"]
pub type DOUTTGL_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PH_DOUTTGL_SPEC, u16, u16, 16, O>;
impl W {
...
#[doc = "Port Data Out Toggle Register\n\nThis register you can [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [ph_douttgl](index.html) module"]
