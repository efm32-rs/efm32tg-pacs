...
pub struct R(crate::R<DDATA3_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DDATA3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DDATA3_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DDATA3_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `DDATA3` writer"]
pub struct W(crate::W<DDATA3_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DDATA3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DDATA3_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DDATA3_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `DDATA3` reader - Double Data 0 Access"]
pub type DDATA3_R = crate::FieldReader<u32, u32>;
#[doc = "Field `DDATA3` writer - Double Data 0 Access"]
pub type DDATA3_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DDATA3_SPEC, u32, u32, 32, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ddata3(&mut self) -> DDATA3_W<0> {
        DDATA3_W::new(self)
    }
