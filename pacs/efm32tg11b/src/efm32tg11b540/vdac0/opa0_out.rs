#[doc = "Register `OPA0_OUT` reader"]
pub struct R(crate::R<OPA0_OUT_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<OPA0_OUT_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<OPA0_OUT_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<OPA0_OUT_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `OPA0_OUT` writer"]
pub struct W(crate::W<OPA0_OUT_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<OPA0_OUT_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<OPA0_OUT_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<OPA0_OUT_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type MAINOUTEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, OPA0_OUT_SPEC, bool, O>;
...
pub type ALTOUTEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, OPA0_OUT_SPEC, bool, O>;
...
pub type APORTOUTEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, OPA0_OUT_SPEC, bool, O>;
...
pub type SHORT_W<'a, const O: u8> = crate::BitWriter<'a, u32, OPA0_OUT_SPEC, bool, O>;
...
pub type ALTOUTPADEN_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, OPA0_OUT_SPEC, u8, ALTOUTPADEN_A, 5, O>;
...
pub type APORTOUTSEL_W<'a, const O: u8> = crate::FieldWriter<'a, u32, OPA0_OUT_SPEC, u8, u8, 8, O>;
impl R {
...
#[doc = "Operational Amplifier Output Configuration Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [opa0_out](index.html) module"]
pub struct OPA0_OUT_SPEC;
impl crate::RegisterSpec for OPA0_OUT_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [opa0_out::R](R) reader structure"]
impl crate::Readable for OPA0_OUT_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [opa0_out::W](W) writer structure"]
impl crate::Writable for OPA0_OUT_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets OPA0_OUT to value 0x01"]
impl crate::Resettable for OPA0_OUT_SPEC {
