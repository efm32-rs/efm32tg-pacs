...
pub type STARTUPDLY_W<'a> = crate::FieldWriter<'a, u32, OPA1_TIMER_SPEC, u8, u8, 6, 0>;
...
pub type WARMUPTIME_W<'a> = crate::FieldWriter<'a, u32, OPA1_TIMER_SPEC, u8, u8, 7, 8>;
...
pub type SETTLETIME_W<'a> = crate::FieldWriter<'a, u32, OPA1_TIMER_SPEC, u16, u16, 10, 16>;
impl R {
