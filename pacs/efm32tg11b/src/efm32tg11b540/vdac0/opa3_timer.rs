...
pub type STARTUPDLY_W<'a, const O: u8> = crate::FieldWriter<'a, u32, OPA3_TIMER_SPEC, u8, u8, 6, O>;
...
pub type WARMUPTIME_W<'a, const O: u8> = crate::FieldWriter<'a, u32, OPA3_TIMER_SPEC, u8, u8, 7, O>;
...
pub type SETTLETIME_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, OPA3_TIMER_SPEC, u16, u16, 10, O>;
impl R {
