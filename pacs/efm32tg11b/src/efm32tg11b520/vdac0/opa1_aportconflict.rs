...
pub struct R(crate::R<OPA1_APORTCONFLICT_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<OPA1_APORTCONFLICT_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<OPA1_APORTCONFLICT_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<OPA1_APORTCONFLICT_SPEC>) -> Self {
        R(reader)
    }
}
...
pub struct OPA1_APORTCONFLICT_SPEC;
impl crate::RegisterSpec for OPA1_APORTCONFLICT_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [opa1_aportconflict::R](R) reader structure"]
impl crate::Readable for OPA1_APORTCONFLICT_SPEC {
    type Reader = R;
}
