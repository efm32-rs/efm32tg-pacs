...
pub type POSSEL_W<'a, const O: u8> = crate::FieldWriter<'a, u32, OPA1_MUX_SPEC, u8, u8, 8, O>;
...
pub type NEGSEL_W<'a, const O: u8> = crate::FieldWriter<'a, u32, OPA1_MUX_SPEC, u8, u8, 8, O>;
...
pub type RESINMUX_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, OPA1_MUX_SPEC, u8, RESINMUX_A, 3, O>;
...
pub type GAIN3X_W<'a, const O: u8> = crate::BitWriter<'a, u32, OPA1_MUX_SPEC, bool, O>;
...
pub type RESSEL_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, OPA1_MUX_SPEC, u8, RESSEL_A, 3, O>;
