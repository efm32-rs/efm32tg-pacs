...
pub type MAINOUTEN_W<'a> = crate::BitWriter<'a, u32, OPA1_OUT_SPEC, bool, 0>;
...
pub type ALTOUTEN_W<'a> = crate::BitWriter<'a, u32, OPA1_OUT_SPEC, bool, 1>;
...
pub type APORTOUTEN_W<'a> = crate::BitWriter<'a, u32, OPA1_OUT_SPEC, bool, 2>;
...
pub type SHORT_W<'a> = crate::BitWriter<'a, u32, OPA1_OUT_SPEC, bool, 3>;
...
pub type ALTOUTPADEN_W<'a> = crate::FieldWriter<'a, u32, OPA1_OUT_SPEC, u8, ALTOUTPADEN_A, 5, 4>;
...
pub type APORTOUTSEL_W<'a> = crate::FieldWriter<'a, u32, OPA1_OUT_SPEC, u8, u8, 8, 16>;
impl R {
