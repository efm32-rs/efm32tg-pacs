...
pub type COMP_W<'a> = crate::FieldWriter<'a, u32, ST1_TCONFA_SPEC, u8, u8, 4, 0>;
#[doc = "Field `MASK` reader - Sensor Mask"]
pub type MASK_R = crate::FieldReader<u8, u8>;
#[doc = "Field `MASK` writer - Sensor Mask"]
pub type MASK_W<'a> = crate::FieldWriter<'a, u32, ST1_TCONFA_SPEC, u8, u8, 4, 4>;
...
pub type NEXTSTATE_W<'a> = crate::FieldWriter<'a, u32, ST1_TCONFA_SPEC, u8, u8, 5, 8>;
...
pub type CHAIN_W<'a> = crate::BitWriter<'a, u32, ST1_TCONFA_SPEC, bool, 14>;
...
pub type SETIF_W<'a> = crate::BitWriter<'a, u32, ST1_TCONFA_SPEC, bool, 15>;
...
pub type PRSACT_W<'a> = crate::FieldWriter<'a, u32, ST1_TCONFA_SPEC, u8, u8, 3, 16>;
impl R {
