...
pub type EXCLK_W<'a, const O: u8> = crate::BitWriter<'a, u32, CH2_INTERACT_SPEC, bool, O>;
...
pub type SAMPLECLK_W<'a, const O: u8> = crate::BitWriter<'a, u32, CH2_INTERACT_SPEC, bool, O>;
