#[doc = "Register `CH8_EVAL` reader"]
pub struct R(crate::R<CH8_EVAL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CH8_EVAL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CH8_EVAL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CH8_EVAL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CH8_EVAL` writer"]
pub struct W(crate::W<CH8_EVAL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CH8_EVAL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CH8_EVAL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CH8_EVAL_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type COMPTHRES_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CH8_EVAL_SPEC, u16, u16, 16, O>;
...
pub type COMP_W<'a, const O: u8> = crate::BitWriter<'a, u32, CH8_EVAL_SPEC, bool, O>;
...
pub type DECODE_W<'a, const O: u8> = crate::BitWriter<'a, u32, CH8_EVAL_SPEC, bool, O>;
...
pub type STRSAMPLE_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CH8_EVAL_SPEC, u8, STRSAMPLE_A, 2, O>;
...
pub type SCANRESINV_W<'a, const O: u8> = crate::BitWriter<'a, u32, CH8_EVAL_SPEC, bool, O>;
...
pub type MODE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CH8_EVAL_SPEC, u8, MODE_A, 2, O>;
...
#[doc = "Scan Configuration\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [ch8_eval](index.html) module"]
pub struct CH8_EVAL_SPEC;
impl crate::RegisterSpec for CH8_EVAL_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [ch8_eval::R](R) reader structure"]
impl crate::Readable for CH8_EVAL_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [ch8_eval::W](W) writer structure"]
impl crate::Writable for CH8_EVAL_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets CH8_EVAL to value 0"]
impl crate::Resettable for CH8_EVAL_SPEC {
