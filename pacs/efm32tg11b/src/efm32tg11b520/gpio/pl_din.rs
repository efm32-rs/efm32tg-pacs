...
pub struct R(crate::R<PL_DIN_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PL_DIN_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PL_DIN_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PL_DIN_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Port Data in Register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pl_din](index.html) module"]
