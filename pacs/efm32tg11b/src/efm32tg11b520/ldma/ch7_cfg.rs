#[doc = "Register `CH7_CFG` reader"]
pub struct R(crate::R<CH7_CFG_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CH7_CFG_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CH7_CFG_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CH7_CFG_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CH7_CFG` writer"]
pub struct W(crate::W<CH7_CFG_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CH7_CFG_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CH7_CFG_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CH7_CFG_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type ARBSLOTS_W<'a> = crate::FieldWriterSafe<'a, u32, CH7_CFG_SPEC, u8, ARBSLOTS_A, 2, 16>;
impl<'a> ARBSLOTS_W<'a> {
...
pub type SRCINCSIGN_W<'a> = crate::BitWriter<'a, u32, CH7_CFG_SPEC, bool, 20>;
...
pub type DSTINCSIGN_W<'a> = crate::BitWriter<'a, u32, CH7_CFG_SPEC, bool, 21>;
impl R {
...
#[doc = "Channel Configuration Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [ch7_cfg](index.html) module"]
pub struct CH7_CFG_SPEC;
impl crate::RegisterSpec for CH7_CFG_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [ch7_cfg::R](R) reader structure"]
impl crate::Readable for CH7_CFG_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [ch7_cfg::W](W) writer structure"]
impl crate::Writable for CH7_CFG_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets CH7_CFG to value 0"]
impl crate::Resettable for CH7_CFG_SPEC {
    #[inline(always)]
