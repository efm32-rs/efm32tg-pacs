...
pub type SIGSEL_W<'a> = crate::FieldWriter<'a, u32, CH0_REQSEL_SPEC, u8, u8, 4, 0>;
#[doc = "Source Select\n\nValue on reset: 0"]
...
pub type SOURCESEL_W<'a> = crate::FieldWriter<'a, u32, CH0_REQSEL_SPEC, u8, SOURCESEL_A, 6, 16>;
