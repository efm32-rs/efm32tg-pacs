...
pub type STRUCTREQ_W<'a, const O: u8> = crate::BitWriter<'a, u32, CH1_CTRL_SPEC, bool, O>;
...
pub type XFERCNT_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CH1_CTRL_SPEC, u16, u16, 11, O>;
...
pub type BYTESWAP_W<'a, const O: u8> = crate::BitWriter<'a, u32, CH1_CTRL_SPEC, bool, O>;
...
pub type BLOCKSIZE_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CH1_CTRL_SPEC, u8, BLOCKSIZE_A, 4, O>;
...
pub type DONEIFSEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, CH1_CTRL_SPEC, bool, O>;
...
pub type REQMODE_W<'a, const O: u8> = crate::BitWriter<'a, u32, CH1_CTRL_SPEC, bool, O>;
...
pub type DECLOOPCNT_W<'a, const O: u8> = crate::BitWriter<'a, u32, CH1_CTRL_SPEC, bool, O>;
#[doc = "Field `IGNORESREQ` reader - Ignore Sreq"]
pub type IGNORESREQ_R = crate::BitReader<bool>;
#[doc = "Field `IGNORESREQ` writer - Ignore Sreq"]
pub type IGNORESREQ_W<'a, const O: u8> = crate::BitWriter<'a, u32, CH1_CTRL_SPEC, bool, O>;
...
pub type SRCINC_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, CH1_CTRL_SPEC, u8, SRCINC_A, 2, O>;
...
pub type SIZE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CH1_CTRL_SPEC, u8, SIZE_A, 2, O>;
...
pub type DSTINC_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, CH1_CTRL_SPEC, u8, DSTINC_A, 2, O>;
