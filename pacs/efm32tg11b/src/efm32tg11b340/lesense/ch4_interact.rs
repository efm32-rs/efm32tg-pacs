...
pub type THRES_W<'a> = crate::FieldWriter<'a, u32, CH4_INTERACT_SPEC, u16, u16, 12, 0>;
...
pub type SAMPLE_W<'a> = crate::FieldWriterSafe<'a, u32, CH4_INTERACT_SPEC, u8, SAMPLE_A, 2, 12>;
impl<'a> SAMPLE_W<'a> {
...
pub type SETIF_W<'a> = crate::FieldWriter<'a, u32, CH4_INTERACT_SPEC, u8, SETIF_A, 3, 14>;
impl<'a> SETIF_W<'a> {
...
pub type EXMODE_W<'a> = crate::FieldWriterSafe<'a, u32, CH4_INTERACT_SPEC, u8, EXMODE_A, 2, 17>;
impl<'a> EXMODE_W<'a> {
    #[doc = "Disabled"]
    #[inline(always)]
...
pub type EXCLK_W<'a> = crate::BitWriter<'a, u32, CH4_INTERACT_SPEC, bool, 19>;
...
pub type SAMPLECLK_W<'a> = crate::BitWriter<'a, u32, CH4_INTERACT_SPEC, bool, 20>;
...
pub type ALTEX_W<'a> = crate::BitWriter<'a, u32, CH4_INTERACT_SPEC, bool, 21>;
impl R {
