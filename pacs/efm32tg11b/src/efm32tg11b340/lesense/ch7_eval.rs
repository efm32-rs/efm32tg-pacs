#[doc = "Register `CH7_EVAL` reader"]
pub struct R(crate::R<CH7_EVAL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CH7_EVAL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CH7_EVAL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CH7_EVAL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CH7_EVAL` writer"]
pub struct W(crate::W<CH7_EVAL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CH7_EVAL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CH7_EVAL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CH7_EVAL_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type COMPTHRES_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CH7_EVAL_SPEC, u16, u16, 16, O>;
...
pub type COMP_W<'a, const O: u8> = crate::BitWriter<'a, u32, CH7_EVAL_SPEC, bool, O>;
...
pub type DECODE_W<'a, const O: u8> = crate::BitWriter<'a, u32, CH7_EVAL_SPEC, bool, O>;
...
pub type STRSAMPLE_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CH7_EVAL_SPEC, u8, STRSAMPLE_A, 2, O>;
...
pub type SCANRESINV_W<'a, const O: u8> = crate::BitWriter<'a, u32, CH7_EVAL_SPEC, bool, O>;
...
pub type MODE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CH7_EVAL_SPEC, u8, MODE_A, 2, O>;
...
pub struct CH7_EVAL_SPEC;
impl crate::RegisterSpec for CH7_EVAL_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [ch7_eval::R](R) reader structure"]
