...
pub struct R(crate::R<BUF13_DATA_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<BUF13_DATA_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<BUF13_DATA_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<BUF13_DATA_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `BUF13_DATA` writer"]
pub struct W(crate::W<BUF13_DATA_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<BUF13_DATA_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<BUF13_DATA_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<BUF13_DATA_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type DATA_W<'a, const O: u8> = crate::FieldWriter<'a, u32, BUF13_DATA_SPEC, u16, u16, 16, O>;
...
#[doc = "Scan Results\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [buf13_data](index.html) module"]
