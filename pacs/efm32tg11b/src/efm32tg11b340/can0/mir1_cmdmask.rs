...
pub type DATAB_W<'a> = crate::BitWriter<'a, u32, MIR1_CMDMASK_SPEC, bool, 0>;
...
pub type DATAA_W<'a> = crate::BitWriter<'a, u32, MIR1_CMDMASK_SPEC, bool, 1>;
...
pub type TXRQSTNEWDAT_W<'a> = crate::BitWriter<'a, u32, MIR1_CMDMASK_SPEC, bool, 2>;
...
pub type CLRINTPND_W<'a> = crate::BitWriter<'a, u32, MIR1_CMDMASK_SPEC, bool, 3>;
...
pub type CONTROL_W<'a> = crate::BitWriter<'a, u32, MIR1_CMDMASK_SPEC, bool, 4>;
...
pub type ARBACC_W<'a> = crate::BitWriter<'a, u32, MIR1_CMDMASK_SPEC, bool, 5>;
...
pub type MASKACC_W<'a> = crate::BitWriter<'a, u32, MIR1_CMDMASK_SPEC, bool, 6>;
#[doc = "Field `WRRD` reader - Write/Read RAM"]
pub type WRRD_R = crate::BitReader<bool>;
#[doc = "Field `WRRD` writer - Write/Read RAM"]
pub type WRRD_W<'a> = crate::BitWriter<'a, u32, MIR1_CMDMASK_SPEC, bool, 7>;
impl R {
