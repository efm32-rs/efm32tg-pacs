#[doc = "Register `PJ_CTRL` reader"]
pub struct R(crate::R<PJ_CTRL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PJ_CTRL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PJ_CTRL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PJ_CTRL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PJ_CTRL` writer"]
pub struct W(crate::W<PJ_CTRL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PJ_CTRL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PJ_CTRL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PJ_CTRL_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type DRIVESTRENGTH_W<'a, const O: u8> = crate::BitWriter<'a, u32, PJ_CTRL_SPEC, bool, O>;
...
pub type SLEWRATE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PJ_CTRL_SPEC, u8, u8, 3, O>;
#[doc = "Field `DINDIS` reader - Data in Disable"]
pub type DINDIS_R = crate::BitReader<bool>;
#[doc = "Field `DINDIS` writer - Data in Disable"]
pub type DINDIS_W<'a, const O: u8> = crate::BitWriter<'a, u32, PJ_CTRL_SPEC, bool, O>;
...
pub type DRIVESTRENGTHALT_W<'a, const O: u8> = crate::BitWriter<'a, u32, PJ_CTRL_SPEC, bool, O>;
...
pub type SLEWRATEALT_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PJ_CTRL_SPEC, u8, u8, 3, O>;
...
pub type DINDISALT_W<'a, const O: u8> = crate::BitWriter<'a, u32, PJ_CTRL_SPEC, bool, O>;
impl R {
...
#[doc = "Port Control Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pj_ctrl](index.html) module"]
pub struct PJ_CTRL_SPEC;
impl crate::RegisterSpec for PJ_CTRL_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pj_ctrl::R](R) reader structure"]
