...
pub struct R(crate::R<PL_MODEL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PL_MODEL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PL_MODEL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PL_MODEL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PL_MODEL` writer"]
pub struct W(crate::W<PL_MODEL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PL_MODEL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PL_MODEL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PL_MODEL_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Pin 0 Mode\n\nValue on reset: 0"]
...
pub type MODE0_W<'a> = crate::FieldWriterSafe<'a, u32, PL_MODEL_SPEC, u8, MODE0_A, 4, 0>;
impl<'a> MODE0_W<'a> {
...
pub type MODE1_W<'a> = crate::FieldWriterSafe<'a, u32, PL_MODEL_SPEC, u8, MODE1_A, 4, 4>;
impl<'a> MODE1_W<'a> {
    #[doc = "Input disabled. Pullup if DOUT is set."]
    #[inline(always)]
    pub fn disabled(self) -> &'a mut W {
...
pub type MODE2_W<'a> = crate::FieldWriterSafe<'a, u32, PL_MODEL_SPEC, u8, MODE2_A, 4, 8>;
impl<'a> MODE2_W<'a> {
    #[doc = "Input disabled. Pullup if DOUT is set."]
    #[inline(always)]
    pub fn disabled(self) -> &'a mut W {
...
pub type MODE3_W<'a> = crate::FieldWriterSafe<'a, u32, PL_MODEL_SPEC, u8, MODE3_A, 4, 12>;
impl<'a> MODE3_W<'a> {
    #[doc = "Input disabled. Pullup if DOUT is set."]
    #[inline(always)]
    pub fn disabled(self) -> &'a mut W {
...
pub type MODE4_W<'a> = crate::FieldWriterSafe<'a, u32, PL_MODEL_SPEC, u8, MODE4_A, 4, 16>;
impl<'a> MODE4_W<'a> {
    #[doc = "Input disabled. Pullup if DOUT is set."]
    #[inline(always)]
    pub fn disabled(self) -> &'a mut W {
...
pub type MODE5_W<'a> = crate::FieldWriterSafe<'a, u32, PL_MODEL_SPEC, u8, MODE5_A, 4, 20>;
impl<'a> MODE5_W<'a> {
    #[doc = "Input disabled. Pullup if DOUT is set."]
    #[inline(always)]
    pub fn disabled(self) -> &'a mut W {
...
pub type MODE6_W<'a> = crate::FieldWriterSafe<'a, u32, PL_MODEL_SPEC, u8, MODE6_A, 4, 24>;
impl<'a> MODE6_W<'a> {
    #[doc = "Input disabled. Pullup if DOUT is set."]
    #[inline(always)]
    pub fn disabled(self) -> &'a mut W {
...
pub type MODE7_W<'a> = crate::FieldWriterSafe<'a, u32, PL_MODEL_SPEC, u8, MODE7_A, 4, 28>;
impl<'a> MODE7_W<'a> {
    #[doc = "Input disabled. Pullup if DOUT is set."]
    #[inline(always)]
    pub fn disabled(self) -> &'a mut W {
