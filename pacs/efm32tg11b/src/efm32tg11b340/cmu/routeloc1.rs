...
pub type CLKIN0LOC_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, ROUTELOC1_SPEC, u8, CLKIN0LOC_A, 6, O>;
impl<'a, const O: u8> CLKIN0LOC_W<'a, O> {
    #[doc = "Location 0"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clkin0loc(&mut self) -> CLKIN0LOC_W<0> {
