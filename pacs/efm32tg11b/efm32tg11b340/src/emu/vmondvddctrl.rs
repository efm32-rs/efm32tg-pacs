...
pub type THRESFINE_W<'a> = crate::FieldWriter<'a, u32, VMONDVDDCTRL_SPEC, u8, u8, 4, 8>;
...
pub type THRESCOARSE_W<'a> = crate::FieldWriter<'a, u32, VMONDVDDCTRL_SPEC, u8, u8, 4, 12>;
impl R {
    #[doc = "Bit 0 - Enable"]
    #[inline(always)]
    pub fn en(&self) -> EN_R {
