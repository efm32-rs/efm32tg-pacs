...
pub type S0INLOC_R = crate::FieldReader<u8, S0INLOC_A>;
impl S0INLOC_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> Option<S0INLOC_A> {
        match self.bits {
...
pub type S0INLOC_W<'a> = crate::FieldWriter<'a, u32, ROUTELOC0_SPEC, u8, S0INLOC_A, 6, 0>;
impl<'a> S0INLOC_W<'a> {
    #[doc = "Location 0"]
    #[inline(always)]
...
pub type S1INLOC_R = crate::FieldReader<u8, S1INLOC_A>;
impl S1INLOC_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> Option<S1INLOC_A> {
        match self.bits {
...
pub type S1INLOC_W<'a> = crate::FieldWriter<'a, u32, ROUTELOC0_SPEC, u8, S1INLOC_A, 6, 8>;
impl<'a> S1INLOC_W<'a> {
    #[doc = "Location 0"]
    #[inline(always)]
    pub fn loc0(self) -> &'a mut W {
