...
pub struct R(crate::R<MIR0_MASK_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<MIR0_MASK_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<MIR0_MASK_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<MIR0_MASK_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `MIR0_MASK` writer"]
pub struct W(crate::W<MIR0_MASK_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<MIR0_MASK_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<MIR0_MASK_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<MIR0_MASK_SPEC>) -> Self {
        W(writer)
    }
}
