...
pub type IRPRSSEL_W<'a> = crate::FieldWriterSafe<'a, u32, IRCTRL_SPEC, u8, IRPRSSEL_A, 3, 8>;
impl<'a> IRPRSSEL_W<'a> {
...
impl R {
    ...
    #[doc = "Bits 8:10 - IrDA PRS Channel Select"]
    #[inline(always)]
    pub fn irprssel(&self) -> IRPRSSEL_R {
        IRPRSSEL_R::new(((self.bits >> 8) & 7) as u8)
    }
}
impl W {
    #[doc = "Bit 0 - Enable IrDA Module"]
